	...
	<div class="flex justify-center mt-32">
		<div class="card card-side bg-base-100 shadow-xl w-2/4">
	  	<figure><img src="https://i.imgur.com/cQGM7Zh.jpeg" alt="ToDoList Image"/></figure>
	  		<div class="card-body">
		    <h2 class="card-title">Registrati a gotlisted</h2>    
				...
				<input type="password" placeholder="conferma password" class="input input-bordered w-full max-w-xs my-2" name="confirm_password" id="confirm_password" required>
				<p>Hai già fatto l'account? Accedi <a href="login" class="text-accent">qui</a>.</p>
