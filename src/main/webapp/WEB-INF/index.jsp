...
<title>gotlisted: Home Page</title>
</head>
<body>
	...
	<div class="hero min-h-screen bg-base-200">
	  <div class="hero-content text-center">
	    <div class="max-w-md">
	      <h1 class="text-5xl font-bold">Benvenuto a gotlisted</h1>
	      <p class="py-6">Un progetto che utilizza il <span class="text-accent">pattern MVC (Model View Control)</span> in Java per implementare una todolist online.</p>
	      <a href="todolist"><button class="btn btn-primary">Accedi alla tua todolist</button></a>
	    </div>
	  </div>
	</div>
</body>
